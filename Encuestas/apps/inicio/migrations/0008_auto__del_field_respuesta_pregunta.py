...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field respuestas on 'Pregunta'
        m2m_table_name = db.shorten_name(u'inicio_pregunta_respuestas')
        ...
        db.create_unique(m2m_table_name, ['pregunta_id', 'respuesta_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field respuestas on 'Pregunta'
        db.delete_table(db.shorten_name(u'inicio_pregunta_respuestas'))
